...
INSERT INTO "new_knowledge_bodies" ("body_type", "confidence_score", "created_at", "exported_doc_id", "growth_phase", "id", "parent_id", "related_entity_ids", "related_fragment_ids", "theme_description", "theme_embedding", "theme_name", "updated_at", "user_id") SELECT "body_type", "confidence_score", "created_at", "exported_doc_id", "growth_phase", "id", "parent_id", "related_entity_ids", "related_fragment_ids", "theme_description", "theme_embedding", "theme_name", "updated_at", "user_id" FROM "knowledge_bodies";
...
CREATE INDEX "knowledge_bodies_user_id_lifecycle_status_idx" ON "knowledge_bodies"("user_id", "lifecycle_status");
...
INSERT INTO "new_theme_discovery_logs" ("bodies_merged", "completed_at", "error", "fragments_scanned", "id", "intent_bodies_created", "stage4_error", "started_at", "status", "themes_found", "triggered_by") SELECT "bodies_merged", "completed_at", "error", "fragments_scanned", "id", "intent_bodies_created", "stage4_error", "started_at", "status", "themes_found", "triggered_by" FROM "theme_discovery_logs";
