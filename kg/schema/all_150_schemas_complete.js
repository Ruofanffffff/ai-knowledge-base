 ...
 * - 50 AI Science  
 * - 50 Photography Tutorial
 * 
 * Each schema is fully defined with all required fields.
 */

// Helper to create schema object
...
const softwareSchemas = [
  ...
  createSchema({
    ...
    entityType: 'DatabaseSchemaEntity',
    scene: '软件开发/数据库',
  ...
  createSchema({
    name: 'Design-Pattern',
    entityType: 'DesignPatternEntity',
    scene: '软件开发/架构',
  ...
  createSchema({
    name: 'Code-Interface',
    entityType: 'CodeInterfaceEntity',
    scene: '软件开发/代码',
  ...
  createSchema({
    ...
    entityType: 'ArchitectureLayerEntity',
    scene: '软件开发/架构',
...
// Continue with remaining software schemas (11-50)...
// Due to length, I'll create them in batches

console.log(`Loaded ${softwareSchemas.length} software development schemas`);
