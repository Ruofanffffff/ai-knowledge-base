/**
 * Add 150 New Schemas to Database
 * 
 * This script adds all 150 schemas across 3 domains to the Prisma database.
 * Run with: node kg/schema/add_150_schemas.js
 */
...
// Import all 150 schema definitions
const allSchemas = [
...
async function addSchemas() {
  console.log(`Adding ${allSchemas.length} schemas to database...`);
...
module.exports = { allSchemas, createSchema };
